...
!function (e, u) {
    ...
    function R(e, u, t) {
        var n = u.href, r = u.title ? T(u.title) : null, u = e[1].replace(/\\([\[\]])/g, "$1");
    ...
    var Z = function () {
        ...
        return u.space = function (e) {
            ...
            if (e) return {type: "escape", raw: e[0], text: T(e[1])}
            ...
            if (t = this.rules.inline.url.exec(e)) {
                if ("@" === t[2]) r = "mailto:" + (n = T(this.options.mangle ? u(t[0]) : t[0])); else {
    ...
    var q = {block: x, inline: q}, j = u.defaults, U = q.block, P = q.inline, L = _;
    ...
    }(), ue = v, te = y, ne = m, m = u.getDefaults, re = u.changeDefaults, u = u.defaults;
